...
if [[ -d "/etc/movivip" ]]; then
    ...
    # FIX v7.0.1: si llega una key por CLI (stub/instalador con licencia) →
    # forzar instalación completa (limpiar y reinstalar). NO delegar al updater,
    # porque el stub ya extrajo el payload y el updater requiere licencia.conf previa.
